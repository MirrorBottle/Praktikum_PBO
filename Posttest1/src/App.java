...
public class App {
    ...
    public static void listDokumenKTP() throws IOException {
        ...
        for (DokumenKTP dokumen : daftarDokumenKTP) {
            ...
            System.out.println("NIK: " + dokumen.NIK);
            System.out.println("Nama: " + dokumen.name);
            System.out.println("Tempat, Tgl Lahir: " + dokumen.birthPlaceDate);
            System.out.println("Jenis Kelamin: " + dokumen.gender);
            System.out.println("Alamat: " + dokumen.address);
            System.out.println("Pekerjaan: " + dokumen.job);
            System.out.println("Kewarganegaraan: " + dokumen.nationality);
            System.out.println("====================================|");
            idx++;
        }
        keypress();
    ...
    public static void listDokumenKK() throws IOException {
        ...
        for (DokumenKK dokumen : daftarDokumenKK) {
            ...
            System.out.println("NIK: " + dokumen.NIK);
            System.out.println("Nama: " + dokumen.name);
            System.out.println("Alasan: " + dokumen.reason);
            System.out.println("No. KK Sebelumnya: " + dokumen.prevIdNumber);
            System.out.println("No. HP: " + dokumen.phoneNumber);
            System.out.println("Alamat: " + dokumen.address);
            System.out.println("Total Anggota Keluarga: " + dokumen.totalFamilyMember);
            System.out.println("====================================|");
            idx++;
        }
        keypress();
